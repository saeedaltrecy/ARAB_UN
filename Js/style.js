...
function toggleAccordion(button) {
    const item = button.closest('.lab-accordion-item');
    const content = item.querySelector('.lab-accordion-content');
    const arrow = button.querySelector('.lab-accordion-arrow');
    const isOpen = !content.classList.contains('hidden');

    // Close all other accordions
    document.querySelectorAll('.lab-accordion-item').forEach(otherItem => {
        if (otherItem !== item) {
            const otherContent = otherItem.querySelector('.lab-accordion-content');
            const otherArrow = otherItem.querySelector('.lab-accordion-arrow');
